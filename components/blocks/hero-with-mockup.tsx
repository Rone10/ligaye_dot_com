        ...
        <div className="relative z-10 flex flex-col items-center gap-6 pt-8 md:pt-16 text-center lg:gap-12">
          ...
          >
            <Button
              ...
              size="lg"
              className={cn(
                "bg-gradient-to-b bg-blue-600 from-brand to-brand/90 dark:from-brand/90 dark:to-brand/80",
            ...
            <Button
              ...
              variant="ghost"
              className={cn(
                "text-foreground/80 dark:text-foreground/70 bg-blue-600/50  hover:bg-blue-400 hover:text-white",
                "transition-all duration-300",
              )}
            >
