    ...
    <div className="min-h-screen bg-gradient-to-br from-[hsl(var(--bg-gradient-from))] to-[hsl(var(--bg-gradient-to))]">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
            <div className="text-center">
              <div className="flex justify-center mb-6">
                <Badge className="bg-secondary/10 text-primary border-secondary/20 px-4 py-2 text-sm font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary to-primary/80 p-8 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500" />
              <div className="relative glass-card p-8 hover:shadow-level-3 transition-all duration-300 hover:-translate-y-2">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-foreground mb-4">One-off Posting</h3>
                  <div className="mb-6">
                    <span className="text-5xl font-bold text-primary">D3,500</span>
                    <span className="text-muted-foreground text-lg ml-2">per job</span>
                  </div>
                  <p className="text-muted-foreground mb-8 leading-relaxed">
                    Perfect for occasional hiring needs. Post a single job and reach qualified candidates.
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-foreground">30-day job visibility</span>
                      </div>
                      <div className="flex items-center">
                        <Check className="w-5 h-5 text-secondary mr-3 flex-shrink-0" />
                        <span className="text-foreground">Unlimited applications</span>
                      </div>
                      <div className="flex items-center">
                        <Check className="w-5 h-5 text-secondary mr-3 flex-shrink-0" />
                        <span className="text-foreground">Basic applicant filtering</span>
                      </div>
                      <div className="flex items-center">
                        <Check className="w-5 h-5 text-secondary mr-3 flex-shrink-0" />
                  ...
                  <Button className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                    Get Started
                  </Button>
                </div>
              </div>
            ...
            <div className="relative group">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                <Badge className="bg-secondary text-white px-4 py-2 text-sm font-semibold shadow-lg">
                  Most Popular
                </Badge>
              </div>
              <div className="absolute inset-0 bg-gradient-to-br from-secondary/20 to-primary/20 rounded-2xl blur-xl opacity-30 group-hover:opacity-50 transition-all duration-500" />
              <div className="relative glass-card border-2 border-secondary/30 p-8 shadow-level-3 hover:shadow-level-4 transition-all duration-300 hover:-translate-y-2 scale-105">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-foreground mb-4">Annual Subscription</h3>
                  <div className="mb-2">
                    <span className="text-5xl font-bold text-secondary">D40,000</span>
                    <span className="text-muted-foreground text-lg ml-2">per year</span>
                  </div>
                  <div className="mb-6">
